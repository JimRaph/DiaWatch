...
from sqlalchemy import create_engine, Column, String, Integer, Boolean,Float, DateTime, JSON, func, ForeignKey
...
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://diawatch:diawatch@db:5432/diawatch")
if not DATABASE_URL:
