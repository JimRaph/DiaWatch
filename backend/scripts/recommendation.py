...
class ClinicalAdvisor:
    ...
    def generate_report(
        ...
        try:
            ...
            return self._generate_fallback_report(
                pred_label, shap_explanations, lifestyle_data
            )
    ...
    def _generate_llm_report(
        ...
        # top risk drivers
        top_drivers = sorted(
            shap_explanations, key=lambda x: abs(x.get("impact", 0)), reverse=True
        )[:3]
        ...
        try:
            ...
            response = client.models.generate_content(
                ...
                contents=prompt,
                config=types.GenerateContentConfig(
                    temperature=0.7, max_output_tokens=2000, top_p=0.9
                ),
            )
            raise
            ...
            default_options = [
                {
                    ...
                    "detail": "Consistent monitoring is key to long-term health management.",
                },
                {
                    "title": "Stay Informed",
                    "detail": "Keep up to date with diabetes prevention through reliable health resources.",
                },
                {
                    "title": "Monitor Symptoms",
                    "detail": "Watch for changes in energy levels or thirst and report them to your doctor.",
                },
            ]
