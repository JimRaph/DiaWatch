...
class InferenceEngine:
        ...
        try:
            ...
            if numeric_data.isnull().any().any():
                ...
                if imputed_values.ndim > 1:
                    df_imputed[self.NUMERIC_FEATURES] = imputed_values[0] if len(imputed_values) == 1 else imputed_values
                else:
    ...
    def _get_model_version(self) -> str:
        try:
            ...
            model_info = client.get_model_version_by_alias(name=self.model_name, alias=self.stage)
