...
export function DateRangeFilter({ onDateRangeChange }: DateRangeFilterProps) {
 ...
 className="flex items-center space-x-2 px-4 py-2 bg-teal-500 text-white rounded-lg hover:opacity-90 transition-opacity"
 >
 ...
 <button
 onClick={handleApply}
 className="flex-1 bg-teal-500 text-white py-2.5 rounded-lg font-semibold hover:opacity-90 transition-opacity"
 >
 Apply Filters
 </button>
 <button
